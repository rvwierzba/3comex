<?php
  ...
  require_once("../painel-adm/tp_declara/campos.php");
  
?>


<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo Tipo Declaração</a>
	<a href="index.php?pag=tp_declara/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
