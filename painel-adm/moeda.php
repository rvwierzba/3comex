<?php
  ...
  require_once("../painel-adm/moeda/campos.php");
  
?>


<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Nova Moeda</a>
	<a href="index.php?pag=moeda/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div class="mb-3">
						...
						<input type="date" class="form-control" name="<?php echo $campo6 ?>" placeholder="<?php echo $campo6 ?>" id="<?php echo $campo6 ?>" required>
					</div>
