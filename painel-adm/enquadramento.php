<?php
  ...
  require_once("../painel-adm/enquadramento/campos.php");
?>

<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo Enquadramento</a>
	<a href="index.php?pag=enquadramento/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
		...
		<div class="modal-content">
			...
			<form id="form" method="post">
				<div class="modal-body">
					...
					<div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Código Tipo Enquadramento</label>
						<input type="text" class="form-control" name="<?php echo $campo3 ?>" placeholder="<?php echo $campo3 ?>" id="<?php echo $campo3 ?>">
					</div>

					<div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Código Grupo Enquadramento</label>
					...
					<div class="mb-3">
						...
						<input type="date" class="form-control" name="<?php echo $campo5 ?>" placeholder="<?php echo $campo5 ?>" id="<?php echo $campo5 ?>">
					</div>
