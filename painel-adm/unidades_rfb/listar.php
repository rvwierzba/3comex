...
echo <<<HTML
	...
	<td>{$cp4}</td>		
	<td>
		<a href="#" onclick="editar('{$id}', '{$cp1}', '{$cp2}', '{$cp3}','{$cp4}', 
		'{$cp5}', '{$cp6}', '{$cp7}', '{$cp8}')" title="Editar Registro">
		...
		<a class="mx-1" href="#" onclick="mostrarDados('{$id}', '{$cp1}', '{$cp2}','{$cp3}', '{$cp4}', 
		'{$cp5}', '{$cp6}', '{$cp7}', '{$cp8}')" data-target="#modalDados" data-id="<?=$id?>" 
