...
<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Nova Unidade RFB</a>
	<a href="index.php?pag=unidades_rfb/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
...
<div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Região Fiscal</label>
						<input type="text" class="form-control" name="<?php echo $campo4 ?>" placeholder="<?php echo $campo4 ?>" id="<?php echo $campo4 ?>" required>
					</div>

          <div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Nome curto</label>
          ...
          <div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Versão (interna)</label>
