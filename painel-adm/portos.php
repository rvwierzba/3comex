<?php
  ...
  require_once("portos/campos.php");
?>

<div class="col-md-12 my-3">
    <a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo Porto</a>
    <a href="index.php?pag=portos/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
            ...
            <form id="form" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="<?php echo $campo3 ?>" placeholder="<?php echo $campo3 ?>" id="<?php echo $campo3 ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Hash (interno)</label>
        ...
        <div class="modal-content">
            ...
            <form id="form-excluir" method="post">
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name="codigo-excluir" id="codigo-excluir">
