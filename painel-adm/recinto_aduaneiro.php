<?php
  ...
  require_once("../painel-adm/recinto_aduaneiro/campos.php");
  
?>


<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo Recinto Aduaneiro</a>
	<a href="index.php?pag=recinto_aduaneiro/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
