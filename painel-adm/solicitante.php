<?php
  ...
  require_once("../painel-adm/solicitante/campos.php");
  
?>


<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo Solicitante</a>
	<a href="index.php?pag=solicitante/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
