<?php
  ...
  require_once("../painel-adm/org_anuente/campos.php");
  
?>


<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo Orgão Anuente</a>
	<a href="index.php?pag=org_anuente/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
...
<script>
	$(document).ready(function() {
		$('#<?=$campo4?>').mask('00.000.000/0000-00');
