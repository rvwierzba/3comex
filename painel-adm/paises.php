...
require_once("paises/campos.php");
?>

<div class="col-md-12 my-3">
    <a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo País</a>
    <a href="index.php?pag=paises/atualizar_tab" type="button" class="btn btn-primary btn-sm">Atualizar tabela</a>
</div>
        ...
        <div class="modal-content">
            ...
            <form id="form" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Código ISO2</label>
                        <input type="text" class="form-control" name="<?php echo $campo1 ?>" placeholder="<?php echo $campo1 ?>" id="<?php echo $campo1 ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Código ISO3</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nome em Inglês</label>
                        <input type="text" class="form-control" name="<?php echo $campo4 ?>" placeholder="<?php echo $campo4 ?>" id="<?php echo $campo4 ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nome em Francês</label>
                        <input type="text" class="form-control" name="<?php echo $campo5 ?>" placeholder="<?php echo $campo5 ?>" id="<?php echo $campo5 ?>">
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Código Numérico</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="<?php echo $campo9 ?>" placeholder="<?php echo $campo9 ?>" id="<?php echo $campo9 ?>" required>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="form-excluir" method="post">
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name="codNum-excluir" id="codNum-excluir">
